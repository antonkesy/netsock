...
int prepare_sender(sockaddr_t *addr, const protocol_t *protocol, int socket_fd) {
    if (*protocol == TCP) {
...
int prepare_listener(sockaddr_t *addr, const protocol_t *protocol, int socket_fd) {
